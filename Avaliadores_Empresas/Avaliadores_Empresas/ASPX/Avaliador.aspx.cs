    ...
    public partial class Avaliador : System.Web.UI.Page
    {
        ...
        protected void Button7_Click(object sender, EventArgs e)
        {
            ...
            AlternateView htmlView = AlternateView.CreateAlternateViewFromString(
              "Olá " + Empresanome() + ",<br><br>A avaliação " + denominacaoemail + " têm um avaliador interessado.<br><br> Aceda aqui para verificar www.portaldoavaliador.com/Empresa <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
              null, "text/html");
        ...
        protected void Button8_Click(object sender, EventArgs e)
        {
            ...
            AlternateView htmlView = AlternateView.CreateAlternateViewFromString(
              "Olá " + Empresanome2() + ",<br><br>O pacote de avaliações " + denominacaoemailpacote + " têm um avaliador interessado.<br><br> Aceda aqui para verificar www.portaldoavaliador.com/Empresa <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
              null, "text/html");
        ...
        void Passadodata()
        {
            string avaliadorsrtng = "select idAvaliacao from tblavaliadoresnumaavaliacao where idAvaliador = " + Session["idAvaliador"].ToString() + " And Escolhido = 1";
            var readerAvaliador = querycall(avaliadorsrtng);
            ...
            MySqlConnection con = new MySqlConnection(constr);
            con.Open();
            string AllAvaliacoes = "SELECT * FROM tblavaliacao where id = '" + avaliadorsrtng + "'";
            MySqlCommand comand = new MySqlCommand(AllAvaliacoes);
            comand.Connection = con;
            comand.ExecuteNonQuery();
            ...
            while (read.Read())
            {
                ...
                if ((myDate - DateTime.Now).TotalDays < 0)
                {
                    ...
                    var readerAvaliadorNome = querycall("select Nome from tblempresa where id = " + read[4].ToString() + "");
        ...
        void PassadodataPacote()
        {
            ...
            var readerAvaliador = querycall("select idAvaliacao from tblavaliadoresnumpacote where idAvaliador = " + Session["idAvaliador"].ToString() + " And Escolhido=1");
            while (readerAvaliador.Read())
            {
                avaliadorsrtng = readerAvaliador[0].ToString();
            }
            ...
            MySqlConnection con = new MySqlConnection(constr);
            con.Open();
            string AllAvaliacoes = "SELECT * FROM tblpacotetotal where id = '" + avaliadorsrtng + "'";
            MySqlCommand comand = new MySqlCommand(AllAvaliacoes);
            comand.Connection = con;
            comand.ExecuteNonQuery();
            ...
            while (read.Read())
            {
                ...
                if ((myDate - DateTime.Now).TotalDays < 0)
                {
                    var readerAvaliadorNome = querycall("select Nome from tblempresa where id = " + read[3].ToString() + "");
                    while (readerAvaliadorNome.Read())
                    {
                        avaliadornomesrtng = readerAvaliadorNome[0].ToString();
                    }
