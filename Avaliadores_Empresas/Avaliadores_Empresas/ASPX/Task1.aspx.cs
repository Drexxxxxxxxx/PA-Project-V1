                        ...
                        if (a["pagamentos"].ToString().Trim('"') != "")
                        {
                            ...
                            if (Estado == "paga")
                            {
                                ...
                                htmlView = AlternateView.CreateAlternateViewFromString(
                                  "O avaliador " + read[1].ToString() + " com o email " + read[3].ToString() + " Renovou a sua conta",
                                  null, "text/html");

                                htmlView.LinkedResources.Add(LinkedImage);
                                mail.AlternateViews.Add(htmlView);
                                mail.IsBodyHtml = true;
                                smtp = new SmtpClient("webmail.portaldoavaliador.com");
                                smtp.Port = 25;
                                smtp.Credentials = new System.Net.NetworkCredential("geral@portaldoavaliador.com", "P@ssword1");
                                smtp.EnableSsl = true;
                                ServicePointManager.ServerCertificateValidationCallback = delegate (object s, X509Certificate certificate, X509Chain chain, SslPolicyErrors sslPolicyErrors) { return true; };
                    ...
                    try
                    {
                        if (a["pagamentos"].ToString().Trim('"') != "")
                        {
                            ...
                            if (Estado == "paga")
                            {
                                ...
                                htmlView = AlternateView.CreateAlternateViewFromString(
                                  "A empresa " + read[1].ToString() + " com o email " + read[3].ToString() + " Renovou a sua conta",
                                  null, "text/html");
            ...
            while (read.Read())
            {
                ...
                if ((myDate - DateTime.Now).TotalDays >= 0)
                {
                    ...
                    if (read[11].ToString() == "0")
                    {
                        ...
                        AlternateView htmlView = AlternateView.CreateAlternateViewFromString(
                          "Olá " + read2[1].ToString() + ",<br><br>Na sequência da avaliação " + read[6].ToString() + " pediamos que dispensasse uns minutos para proceder a avaliação do avaliador " + read3[1].ToString() + ".<br><br>Aceda aqui para fazer a avaliação www.portaldoavaliador.com/Empresa <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
                          null, "text/html");
                        ...
                        AlternateView htmlview2 = AlternateView.CreateAlternateViewFromString(
                          "Olá " + read3[1].ToString() + ",<br><br>Na sequência da avaliação " + read[6].ToString() + " pediamos que dispensasse uns minutos para proceder a avaliação da empresa " + read2[1].ToString() + ".<br><br>Aceda aqui para fazer a avaliação www.portaldoavaliador.com/Avaliador <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
                          null, "text/html");
            ...
            while (read.Read())
            {
                ...
                if ((myDate - DateTime.Now).TotalDays >= 0)
                {
                    ...
                    if (read[9].ToString() == "0")
                    {
                        ...
                        AlternateView htmlView = AlternateView.CreateAlternateViewFromString(
                          "Olá " + read2[1].ToString() + ",<br><br>Na sequência do pacote de avaliação " + read[1].ToString() + " pediamos que dispensasse uns minutos para proceder a avaliação do avaliador " + read3[1].ToString() + ".<br><br>Aceda aqui para fazer a avaliação www.portaldoavaliador.com/Empresa <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
                          null, "text/html");
                        ...
                        AlternateView htmlview2 = AlternateView.CreateAlternateViewFromString(
                          "Olá " + read3[1].ToString() + ",<br><br>Na sequência da avaliação " + read[1].ToString() + " pediamos que dispensasse uns minutos para proceder a avaliação da empresa " + read2[1].ToString() + ".<br><br>Aceda aqui para fazer a avaliação www.portaldoavaliador.com/Avaliador <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
                          null, "text/html");
            ...
            while (read.Read())
            {
                ...
                if ((myDate - DateTime.Now).TotalDays <= 0)
                {
                    if (read[12].ToString() == "0")
                    {
                        ...
                        AlternateView htmlView = AlternateView.CreateAlternateViewFromString(
                          "Olá " + read[1].ToString() + ",<br><br>Falta 1 dia para acabar a sua licença, pediamos que dispensasse uns minutos para Renovar a sua conta.<br><br>Aceda aqui para fazer a renovação www.portaldoavaliador.com/Avaliador <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
                          null, "text/html");
            ...
            while (read.Read())
            {
                ...
                if ((myDate - DateTime.Now).TotalDays <= 0)
                {
                    if (read[12].ToString() == "0")
                    {
                        ...
                        AlternateView htmlView = AlternateView.CreateAlternateViewFromString(
                          "Olá " + read[1].ToString() + ",<br><br>Falta 1 dia para acabar a sua licença, pediamos que dispensasse uns minutos para Renovar a sua conta.<br><br>Aceda aqui para fazer a renovação www.portaldoavaliador.com/Empresa <br><br>Alguma questão não hesite em contactar,<br><br><div>" + @"<div style=""display: inline-block;""> <img style=""width:65px;"" src='cid:" + LinkedImage.ContentId + @"'/></div><div style=""display: inline-block;"">Portal do avaliador <br> www.portaldoavaliador.com</div></div>",
                          null, "text/html");
