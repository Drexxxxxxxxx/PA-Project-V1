            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active botoestoolbar"><a class="botoestoolbar" href="Login.aspx"><span class="glyphicon glyphicon-log-in" style="padding-right:2px"></span>Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
           <div style="position: relative; text-align: center; height: 91%;">
            ...
            <div style="position: absolute; overflow-y:auto; padding-top:10px; max-height: 80%; max-width: 98%; min-width: 200px; top: 50%; left: 0%; right: 0%; transform: translate(-0%, -50%); z-index: 2;">
                ...
                <div class="DivsContacto">
                    <asp:Label ID="Label1" runat="server" CssClass="LabelPaddingright" Text="Nome"></asp:Label><asp:TextBox ID="txt_email" placeholder="Email" CssClass="textboxContactos" runat="server"></asp:TextBox>
                    
                </div><br /><br />
                <div class="DivsContacto">
                    <asp:Label ID="Label2" runat="server" CssClass="LabelPaddingright" Text="Email"></asp:Label><asp:TextBox ID="txt_pass" placeholder="Password" CssClass="textboxContactos" TextMode="Password" runat="server"></asp:TextBox>
                </div><br /><br />
                <div class="DivsContacto">
