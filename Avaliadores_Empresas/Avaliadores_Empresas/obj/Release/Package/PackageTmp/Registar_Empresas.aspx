           ...
           <div style="position: relative; text-align: center; height: 91%;">
            ...
            <div style="position: absolute; overflow-y:auto; padding-top:10px; max-height: 95%; max-width: 100%; min-width: 200px; top: 50%; left: 0%; right: 0%; transform: translate(-0%, -50%); z-index: 2;">
                ...
                <div class="DivsContacto">
                    <asp:Label ID="Label1" runat="server" CssClass="LabelPaddingright" Text="Nome"></asp:Label> <asp:TextBox ID="nome_emp"  CssClass="textboxContactos" runat="server"></asp:TextBox>
                ...
                <div class="DivsContacto">
                    <asp:Label ID="Label3" runat="server" CssClass="LabelPaddingright" Text="Número de telefone"></asp:Label> <asp:TextBox ID="mobile_emp"  CssClass="textboxContactos" MaxLength="9" runat="server"></asp:TextBox>
                </div><br /><br />
                <div class="DivsContacto">
