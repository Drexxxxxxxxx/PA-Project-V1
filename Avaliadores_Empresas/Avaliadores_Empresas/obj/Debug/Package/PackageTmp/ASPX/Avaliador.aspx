                                ...
                                <div class="divPerfil_inner">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <br />
                                                    <br />
                                                    <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Renovar por mais 30 dias (10€)" />
                                                    &nbsp;
                                        ...
                                        <div class="col-6">
                                            ...
                                            <br />
                                            <asp:Button ID="Button1" CssClass="btn btn-dark" runat="server" OnClick="Button1_Click" Style="display: none;" Text="Apagar Área Selecionada" />
                                            <script>
                                            ...
                                            <asp:Button ID="Button4" runat="server" Text="Mudar Password" CssClass="btn btn-change-pswd" OnClick="Button1_Click1" />
